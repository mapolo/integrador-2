...
public class GrupoLogic implements IGrupoLogic {
	...
	public void saveGrupo(Grupo entity) throws Exception {
		try {
			/*
			 * if (entity.getFamilia() == null) { throw new ZMessManager().new
			 * ForeignException("familia"); }
			 */
			...
			/*
			 * if (entity.getFamilia().getIdFlia() == null) { throw new
			 * ZMessManager().new EmptyFieldException( "idFlia_Familia"); }
			 */

			/*
			 * if ((entity.getFamilia() != null) &&
			 * (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
			 * entity.getFamilia().getIdFlia(), 10, 0) == false)) { throw new
			 * ZMessManager().new NotValidFormatException( "idFlia_Familia"); }
			 */
