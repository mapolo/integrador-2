...
public class PeriodoGarantiaLogic implements IPeriodoGarantiaLogic {
	...
	public void savePeriodoGarantia(PeriodoGarantia entity) throws Exception {
		try {
			...
			/*
			 * if (entity.getIdPega() == null) { throw new ZMessManager().new
			 * EmptyFieldException("idPega"); }
			 * 
			 * if ((entity.getIdPega() != null) &&
			 * (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
			 * entity.getIdPega(), 10, 0) == false)) { throw new
			 * ZMessManager().new NotValidFormatException("idPega"); }
			 */
			...
			/*
			 * if (getPeriodoGarantia(entity.getIdPega()) != null) { throw new
