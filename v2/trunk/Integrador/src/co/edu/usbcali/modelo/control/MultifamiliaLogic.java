...
import co.edu.usbcali.dataaccess.dao.IMultifamiliaDAO;
	...
	public List<MultifamiliaDTO> getDataMultifamilia() throws Exception {
		try {
			...
			for (Multifamilia multifamiliaTmp : multifamilia) {
				...
				multifamiliaDTO2.setEstadoRegistro((multifamiliaTmp
						.getEstadoRegistro() != null) ? multifamiliaTmp
						.getEstadoRegistro() : null);
				multifamiliaDTO2.setFechaCreacion(multifamiliaTmp
						.getFechaCreacion());
				multifamiliaDTO2.setFechaModificacion(multifamiliaTmp
						.getFechaModificacion());
				multifamiliaDTO2.setOperCreador((multifamiliaTmp
						.getOperCreador() != null) ? multifamiliaTmp
						.getOperCreador() : null);
				multifamiliaDTO2.setOperModifica((multifamiliaTmp
						.getOperModifica() != null) ? multifamiliaTmp
						.getOperModifica() : null);

				if (multifamiliaTmp.getSucursal() != null) {
					multifamiliaDTO2.setIdSucu_Sucursal(multifamiliaTmp
