 ...
 */
@Scope("singleton")
@Service("AtencionVendedorLogic")
public class AtencionVendedorLogic implements IAtencionVendedorLogic {
	/**
	 ...
	 */
	@Autowired
	IRelacionComercialLogic logicRelacionComercial1;
	...
	public List<AtencionVendedor> getAtencionVendedor() throws Exception {
		List<AtencionVendedor> list = new ArrayList<AtencionVendedor>();

		try {
			list = atencionVendedorDAO.findAll();
		} catch (Exception e) {
	...
	public void deleteAtencionVendedor(AtencionVendedor entity)
			throws Exception {
		if (entity == null) {
			throw new ZMessManager().new NullEntityExcepcion("AtencionVendedor");
		}
		...
		List<ProgramacionAdicional> programacionAdicionals = null;
		List<ProgramacionVisitas> programacionVisitases = null;
		List<RutaRelacionComercial> rutaRelacionComercials = null;

		try {
			contactos = contactoDAO.findByProperty("atencionVendedor.idAtve",
					entity.getIdAtve());
			...
			programacionAdicionals = programacionAdicionalDAO.findByProperty(
					"atencionVendedor.idAtve", entity.getIdAtve());

			if (Utilities.validationsList(programacionAdicionals) == true) {
				throw new ZMessManager().new DeletingException(
						"programacionAdicionals");
			}
			...
			atencionVendedorDAO.delete(entity);
		} catch (Exception e) {
			throw e;
		} finally {
		}
	...
	public void updateAtencionVendedor(AtencionVendedor entity)
		...
		try {
			...
			atencionVendedorDAO.update(entity);
		} catch (Exception e) {
			throw e;
		} finally {
		}
	...
	public List<AtencionVendedorDTO> getDataAtencionVendedor() throws Exception {
		try {
			List<AtencionVendedor> atencionVendedor = atencionVendedorDAO
					.findAll();

			List<AtencionVendedorDTO> atencionVendedorDTO = new ArrayList<AtencionVendedorDTO>();

			for (AtencionVendedor atencionVendedorTmp : atencionVendedor) {
				AtencionVendedorDTO atencionVendedorDTO2 = new AtencionVendedorDTO();

				atencionVendedorDTO2.setIdAtve(atencionVendedorTmp.getIdAtve());
				atencionVendedorDTO2.setEstadoRegistro((atencionVendedorTmp
						.getEstadoRegistro() != null) ? atencionVendedorTmp
						.getEstadoRegistro() : null);
				atencionVendedorDTO2.setFechaCreacion(atencionVendedorTmp
						.getFechaCreacion());
				atencionVendedorDTO2.setFechaModificacion(atencionVendedorTmp
						.getFechaModificacion());
				atencionVendedorDTO2.setOperCreador((atencionVendedorTmp
						.getOperCreador() != null) ? atencionVendedorTmp
						.getOperCreador() : null);
				atencionVendedorDTO2.setOperModifica((atencionVendedorTmp
						.getOperModifica() != null) ? atencionVendedorTmp
						.getOperModifica() : null);
				atencionVendedorDTO2
						.setIdReco_RelacionComercial((atencionVendedorTmp
								.getRelacionComercial().getIdReco() != null) ? atencionVendedorTmp
								.getRelacionComercial().getIdReco() : null);
				atencionVendedorDTO2
						.setIdVend_Vendedor((atencionVendedorTmp.getVendedor()
								.getIdVend() != null) ? atencionVendedorTmp
								.getVendedor().getIdVend() : null);
				atencionVendedorDTO.add(atencionVendedorDTO2);
			}

			return atencionVendedorDTO;
		} catch (Exception e) {
			throw e;
		}
	}
	...
	public AtencionVendedor getAtencionVendedor(Long idAtve) throws Exception {
		AtencionVendedor entity = null;

		try {
			entity = atencionVendedorDAO.findById(idAtve);
		} catch (Exception e) {
			throw new ZMessManager().new FindingException("AtencionVendedor");
		} finally {
		}
	...
	public List<AtencionVendedor> findPageAtencionVendedor(
		...
		List<AtencionVendedor> entity = null;

		try {
			entity = atencionVendedorDAO.findPage(sortColumnName,
					sortAscending, startRow, maxResults);
		} catch (Exception e) {
			throw new ZMessManager().new FindingException(
					"AtencionVendedor Count");
		} finally {
		}
	...
	public Long findTotalNumberAtencionVendedor() throws Exception {
		...
		try {
			entity = atencionVendedorDAO.count();
		} catch (Exception e) {
			throw new ZMessManager().new FindingException(
					"AtencionVendedor Count");
		} finally {
	...
	public List<AtencionVendedor> findByCriteria(Object[] variables,
		...
		try {
			list = atencionVendedorDAO.findByCriteria(where);
		} catch (Exception e) {
