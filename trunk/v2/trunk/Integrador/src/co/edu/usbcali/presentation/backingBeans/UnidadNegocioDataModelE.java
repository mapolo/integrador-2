...
public class UnidadNegocioDataModelE extends ListDataModel<UnidadNegocioDTO> implements SelectableDataModel<UnidadNegocioDTO> {    
  
    public UnidadNegocioDataModelE() {  
    }  
  
    public UnidadNegocioDataModelE(List<UnidadNegocioDTO> data) {  
        super(data);  
    }  
