...
public class DescuentoFinancieroView {
	...
	public void onEdit(org.primefaces.event.RowEditEvent event) {
		...
		try {
			...
			TipoFormaPago entity2 = businessDelegatorView.getTipoFormaPago(Long
					.parseLong(idTfpa_TipoFormaPago));
			System.out.println("1: " + txtIdTfpa_TipoFormaPago.getValue()
					+ " 2: " + entity2);
	...
	public DescuentoFinancieroDataModel getDescuentoFinancieroDataModel() {
		return descuentoFinancieroDataModel;
	}
