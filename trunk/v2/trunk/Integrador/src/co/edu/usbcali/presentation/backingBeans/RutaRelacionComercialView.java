...
public class RutaRelacionComercialView {
    ...
    public void rowEventListener(RowEditEvent e) {
        try {
            RutaRelacionComercialDTO rutaRelacionComercialDTO = (RutaRelacionComercialDTO) e.getObject();

            if (txtEstadoRegistro == null) {
                txtEstadoRegistro = new InputText();
            }

            txtEstadoRegistro.setValue(rutaRelacionComercialDTO.getEstadoRegistro());
            ...
            txtOperModifica.setValue(rutaRelacionComercialDTO.getOperModifica());

            if (txtIdAtve_AtencionVendedor == null) {
                txtIdAtve_AtencionVendedor = new InputText();
            }

            txtIdAtve_AtencionVendedor.setValue(rutaRelacionComercialDTO.getIdAtve_AtencionVendedor());

            if (txtIdRudi_RutaDistribucion == null) {
                txtIdRudi_RutaDistribucion = new InputText();
            }

            txtIdRudi_RutaDistribucion.setValue(rutaRelacionComercialDTO.getIdRudi_RutaDistribucion());
            ...
            txtFechaCreacion.setValue(rutaRelacionComercialDTO.getFechaCreacion());

            if (txtFechaModificacion == null) {
                txtFechaModificacion = new Calendar();
            }

            txtFechaModificacion.setValue(rutaRelacionComercialDTO.getFechaModificacion());
    ...
    public String action_edit(ActionEvent evt) {
        selectedRutaRelacionComercial = (RutaRelacionComercialDTO) (evt.getComponent()
                                                                       .getAttributes()
                                                                       .get("selectedRutaRelacionComercial"));
        txtEstadoRegistro.setValue(selectedRutaRelacionComercial.getEstadoRegistro());
        txtEstadoRegistro.setDisabled(false);
        txtFechaCreacion.setValue(selectedRutaRelacionComercial.getFechaCreacion());
        txtFechaCreacion.setDisabled(false);
        txtFechaModificacion.setValue(selectedRutaRelacionComercial.getFechaModificacion());
        txtFechaModificacion.setDisabled(false);
        txtOperCreador.setValue(selectedRutaRelacionComercial.getOperCreador());
        txtOperCreador.setDisabled(false);
        txtOperModifica.setValue(selectedRutaRelacionComercial.getOperModifica());
        txtOperModifica.setDisabled(false);
        txtIdAtve_AtencionVendedor.setValue(selectedRutaRelacionComercial.getIdAtve_AtencionVendedor());
        txtIdAtve_AtencionVendedor.setDisabled(false);
        txtIdRudi_RutaDistribucion.setValue(selectedRutaRelacionComercial.getIdRudi_RutaDistribucion());
        txtIdRudi_RutaDistribucion.setDisabled(false);
    ...
    public String action_create() {
        try {
            ...
            entity.setAtencionVendedor(businessDelegatorView.getAtencionVendedor(
                    FacesUtils.checkLong(txtIdAtve_AtencionVendedor)));
            entity.setRutaDistribucion(businessDelegatorView.getRutaDistribucion(
                    FacesUtils.checkLong(txtIdRudi_RutaDistribucion)));
    ...
    public String action_modifyWitDTO(String estadoRegistro,
        ...
        String operCreador, String operModifica, Long idAtve_AtencionVendedor,
        Long idRudi_RutaDistribucion) throws Exception {
        try {
